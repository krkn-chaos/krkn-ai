...
class TestAdaptMutationRateEarlyReturns:
    ...
    def test_returns_early_when_disabled(self, genetic_algorithm):
        ...
        genetic_algorithm.algo_config.adaptive_mutation.enable = False
        genetic_algorithm.stagnant_generations = 10
        original_rate = genetic_algorithm.algo_config.scenario_mutation_rate
        ...
        assert genetic_algorithm.algo_config.scenario_mutation_rate == original_rate
    ...
    def test_returns_early_with_insufficient_generations(
        ...
        genetic_algorithm.algo_config.adaptive_mutation.enable = True
...
class TestAdaptMutationRateUpdate:
    ...
    def test_save_config_uses_original_rate_after_adaptation(self, genetic_algorithm):
        ...
        assert saved_config["genetic"]["scenario_mutation_rate"] == original_rate
